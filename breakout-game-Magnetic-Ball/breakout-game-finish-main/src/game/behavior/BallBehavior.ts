...
export class BallBehavior extends GameObjectBehavior {
    ...
    protected init() {
        ...
        EventDispatcher.getInstance().getDispatcher().on(GameEvents.MAGNETIC_BALL, this.magneticBall, this);
    ...
    private stickToPaddle() {
        if (this.ballImg.tint != 0x0074FD) {
            return;
        }
        this.followPaddle();
        this.isPlaying = false;
    ...
    private magneticBall() {

        this.ballImg.tint = 0x0074FD;
        this.ballImg.scale.x = (1.4);
        this.ballImg.scale.y = (1.4);
        this.ballImg.anchor.set(0.5, 1.3);
        this.velocity = 4;
    }
    ...
    private resetBall() {
        ...
        this.ballImg.tint = 0xffffff;
        this.ballImg.scale.x = (1);
        this.ballImg.scale.y = (1);
        this.ballImg.anchor.set(0.5);
        this.velocity = 6;
    }
